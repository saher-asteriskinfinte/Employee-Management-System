...
const Completetask = ({data}) => {
  return (
    <div><div className='h-[95%] w-60 rounded-xl bg-purple-400 p-4 shrink-0'>
    ...
    <div className="mt-4">
    <button className='bg-blue-500 py-1 rounded-md px-2 text-[0.65rem] nowrap'>Completed</button>
    </div>
    </div></div>
  )
}
